...
6. Otherwise, build the smallest complete path and prove it.
...
```bash
hermes skills install https://raw.githubusercontent.com/FYN-Labs/aaa-code-doctrine/v0.1.0/plugins/aaa-code/skills/aaa-code/SKILL.md --yes
hermes skills install https://raw.githubusercontent.com/FYN-Labs/aaa-code-doctrine/v0.1.0/plugins/aaa-code/skills/aaa-code-review/SKILL.md --yes
```
...
native Codex plugin validator, both Agent Skills validators, and
